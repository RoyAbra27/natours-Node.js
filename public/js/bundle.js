...
/*eslint-disable*/ const $aacb8cd1916d432d$export$de026b00723010c1 = (
  type,
  msg
) => {
...
const $2359206674280748$export$596d806903d1f59e = async (email, password) => {
  try {
    ...
    if (res.data.status === 'success') {
      (0, $aacb8cd1916d432d$export$de026b00723010c1)(
        'success',
...
/* eslint-disable*/ const $b1881d2d36b9b1c3$export$4c5dd147b21b9176 = (
  locations
) => {
  var map = tt.map({
...
/*eslint-disable */
const $d4a631fe91d89b04$var$stripe = Stripe(
...
const $404e9fa2a66ba856$var$logOutBtn =
  document.querySelector('.nav__el--logout');
const $404e9fa2a66ba856$var$userDataForm =
  document.querySelector('.form-user-data');
const $404e9fa2a66ba856$var$userPasswordForm = document.querySelector(
  '.form-user-password'
);
const $404e9fa2a66ba856$var$bookBtn = document.getElementById('book-tour');
if ($404e9fa2a66ba856$var$mapDisplay) {
  const locations = JSON.parse(
    $404e9fa2a66ba856$var$mapDisplay.dataset.locations
  );
  (0, $b1881d2d36b9b1c3$export$4c5dd147b21b9176)(locations);
}
if ($404e9fa2a66ba856$var$loginForm)
  $404e9fa2a66ba856$var$loginForm.addEventListener('submit', (e) => {
    e.preventDefault();
    const email = document.getElementById('email').value;
    const password = document.getElementById('password').value;
    (0, $2359206674280748$export$596d806903d1f59e)(email, password);
  });
if ($404e9fa2a66ba856$var$logOutBtn)
  $404e9fa2a66ba856$var$logOutBtn.addEventListener(
    'click',
    (0, $2359206674280748$export$a0973bcfe11b05c9)
  );
if ($404e9fa2a66ba856$var$userDataForm)
  $404e9fa2a66ba856$var$userDataForm.addEventListener('submit', (e) => {
    e.preventDefault();
...
if ($404e9fa2a66ba856$var$userPasswordForm)
  $404e9fa2a66ba856$var$userPasswordForm.addEventListener(
    'submit',
    async (e) => {
      e.preventDefault();
...
if ($404e9fa2a66ba856$var$bookBtn)
  $404e9fa2a66ba856$var$bookBtn.addEventListener('click', (e) => {
